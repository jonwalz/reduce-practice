    ...
    const averageIMDBRating = filteredMovies.reduce((total, movie, index, array) => {
    ...
    const averageRating = watchList
        ...
        .reduce((total, movie, index, array) => (total += parseFloat(movie.imdbRating) / array.length), 0)
    ...
    const output = inputWords.reduce((acc, word) => ({ ...acc, [word]: (acc[word] || 0) + 1 }), {})
